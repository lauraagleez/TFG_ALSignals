...
| `04_model_deep_learning_v1.0.ipynb` | LSTM bidireccional (2 capas, hidden=256) sobre mel spectrograms. VariableLengthCollator con padding y máscaras, class weighting (ALS=2, HC=1), early stopping | ✅ Completo (Revisar) | checkpoint LSTM v1.0, curvas de aprendizaje, métricas val/test |
...
| `05_model_comparison.ipynb` | Evaluación final en test de todos los modelos. Tabla comparativa global RF v1/v2 vs DL v1/v2, curvas ROC superpuestas, análisis de errores clínicamente relevantes, selección del modelo definitivo | 🔵 En curso | tabla final, figura ROC comparativa, decisión modelo definitivo |
